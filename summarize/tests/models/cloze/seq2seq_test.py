...
class TestClozeSeq2SeqModel(ModelTestCase):
    def setUp(self):
        super().setUp()
        self.set_up_model(f'{FIXTURES_ROOT}/configs/cloze/seq2seq.jsonnet',
                          f'{FIXTURES_ROOT}/data/cloze.jsonl')

    def test_cloze_seq2seq_can_train_save_and_load(self):
